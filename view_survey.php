	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				...
				<form action="" id="manage-sort" method="POST">
				...
				<div class="card-tools">
						<button type="submit" class="btn btn-block btn-sm btn-default btn-flat border-success" name="submit"><i class="fa fa-plus"></i> Submit</button>
					</div>
					<?php
